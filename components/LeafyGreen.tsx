...
import styles from "./LeafyGreen.module.scss";
...
export default function LeafyGreen(props: Props) {
  const plantCustomProperties = useMemo<CSSProperties>(() => {
  ...
  return (
    ...
    >
      {props.count >= leafPoints.leaf8 && (
        <>
          <path
            className={styles.leaf + " " + styles.leaf8}
          ...
          />
          <path
            className={styles.leaf + " " + styles.leaf7}
      ...
      {props.count >= leafPoints.leaf6 && (
        <path
          className={styles.leaf + " " + styles.leaf6}
      ...
      {props.count >= leafPoints.leaf5 && (
        <path
          className={styles.leaf + " " + styles.leaf5}
      ...
      <path className={styles.stem} d="M32 8V240" stroke="#006D1F" />
    </svg>
  );
}
